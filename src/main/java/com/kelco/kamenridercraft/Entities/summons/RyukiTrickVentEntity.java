...
public class RyukiTrickVentEntity extends BaseSummonEntity {

	public RyukiTrickVentEntity(EntityType<? extends RyukiTrickVentEntity> type, Level level) {
		super(type, level);
		NAME="ryuki_trick_vent";
	...
	public void aiStep() {
		...
		if ( this.getOwner() instanceof Player owner) {
			...
			||owner.getItemBySlot(EquipmentSlot.FEET).getItem()!=Ryuki_Rider_Items.RYUKIDRIVER.get()) this.setHealth(0);
		}    	
