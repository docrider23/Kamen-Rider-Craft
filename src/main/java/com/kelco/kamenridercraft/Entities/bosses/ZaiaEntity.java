...
public class ZaiaEntity extends BaseHenchmenEntity {
	

	
    public ZaiaEntity(EntityType<? extends Zombie> type, Level level) {
        super(type, level);
        NAME="zaia";
        ...
        this.setItemSlot(EquipmentSlot.FEET, new ItemStack(Zero_One_Rider_Items.ZAIA_THOUSANDRIVER_ZAIA.get()));
        this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(Zero_One_Rider_Items.THOUSAND_JACKER.get()));
    }
