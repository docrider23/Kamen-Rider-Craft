...
public class NakiEntity extends BaseHenchmenEntity {
	

	
    public NakiEntity(EntityType<? extends Zombie> type, Level level) {
        super(type, level);
        NAME="naki";
        ...
        this.setItemSlot(EquipmentSlot.FEET, new ItemStack(Zero_One_Rider_Items.FORCERISER_NAKI.get()));
    }
