...
public class  PoweredUpCoreEntity extends BaseHenchmenEntity {
    ...
    public  PoweredUpCoreEntity(EntityType<? extends Zombie> type, Level level) {
        super(type, level);
              ...
              if (d0 < 4.0D) {
                 ...
                 if (this.attackTime <= 0) {
                    ...
                    if (this.attackStep > 1) {
                       ...
                       for(int i = 0; i < 1; ++i) {
                          LargeFireball smallfireball = new LargeFireball(this. PoweredUpCoreEntity.level(), this. PoweredUpCoreEntity, this. PoweredUpCoreEntity.getRandom().triangle(d1, 2.297D * d4), d2, this. PoweredUpCoreEntity.getRandom().triangle(d3, 2.297D * d4), 2);
