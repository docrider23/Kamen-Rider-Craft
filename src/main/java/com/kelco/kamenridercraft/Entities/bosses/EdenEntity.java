...
public class EdenEntity extends BaseHenchmenEntity {
	

	
    public EdenEntity(EntityType<? extends Zombie> type, Level level) {
        super(type, level);
        NAME="eden";
        ...
        this.setItemSlot(EquipmentSlot.FEET, new ItemStack(Zero_One_Rider_Items.EDEN_DRIVER.get()));
