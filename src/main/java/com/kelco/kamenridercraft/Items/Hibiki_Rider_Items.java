...
import com.kelco.kamenridercraft.Items.hibiki.ArmedSaberItem;
...
public class Hibiki_Rider_Items {
	  ...
	  public static final DeferredRegister<Item> ITEMS = DeferredRegister.create(ForgeRegistries.ITEMS, KamenRiderCraftCore.MODID);
	    ...
	    public static final RegistryObject<Item> HIBIKI_LOGO = ITEMS.register("hibiki_logo",
	    		() -> new BaseItem(new Item.Properties()).AddToTabList(RiderTabs.HIBIKI_TAB_ITEM));
 
        public static final RegistryObject<Item> ONI_ORE = ITEMS.register("oni_ore",
		        () -> new BaseItem(new Item.Properties()).AddToTabList(RiderTabs.HIBIKI_TAB_ITEM));
        public static final RegistryObject<Item> ONI_OREHELL = ITEMS.register("oni_orehell",
                () -> new BaseItem(new Item.Properties()).AddToTabList(RiderTabs.HIBIKI_TAB_ITEM));
        public static final RegistryObject<Item> UNFINISHED_ARMED_SABER = ITEMS.register("unfinished_armed_saber",
                () -> new BaseItem(new Item.Properties()).AddToTabList(RiderTabs.HIBIKI_TAB_ITEM));

        
        public static final RegistryObject<Item> HENSHIN_ONSA = ITEMS.register("henshin_onsa",
        ...
        public static final RegistryObject<Item> HENSHIN_ONSA_KURENAI = ITEMS.register("henshin_onsa_kurenai",
        () -> new RiderFormChangeItem(new Item.Properties(),0,"_kurenai","hibiki","hibikidriver_belt",
                new MobEffectInstance(MobEffects.DAMAGE_BOOST, 40, 1,true,false),
                new MobEffectInstance(MobEffects.DIG_SPEED, 40, 3,true,false),
                new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 40, 0,true,false),
                new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 40, 1,true,false)).AddToTabList(RiderTabs.HIBIKI_TAB_ITEM));

        public static final RegistryObject<Item> HENSHIN_ONSA_ARMED = ITEMS.register("henshin_onsa_armed",
        ...
        public static final RegistryObject<Item> HENSHIN_ONSA_DANKI = ITEMS.register("henshin_onsa_danki",
        () -> new RiderFormChangeItem(new Item.Properties(),0,"","danki","dankidriver_belt",
                new MobEffectInstance(MobEffects.DIG_SPEED, 40, 1,true,false),
                new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 40, 1,true,false)).AddToTabList(RiderTabs.HIBIKI_TAB_ITEM));

        public static final RegistryObject<Item> HENSHIN_ONSA_EIKI = ITEMS.register("henshin_onsa_eiki",
        () -> new RiderFormChangeItem(new Item.Properties(),0,"","eiki","eikidriver_belt",
                new MobEffectInstance(MobEffects.WATER_BREATHING, 40, 0,true,false),
                new MobEffectInstance(MobEffects.FIRE_RESISTANCE, 40, 0,true,false),
                new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 40, 1,true,false)).AddToTabList(RiderTabs.HIBIKI_TAB_ITEM));

        public static final RegistryObject<Item> HENSHIN_ONSA_GOUKI = ITEMS.register("henshin_onsa_gouki",
        ...
        public static final RegistryObject<Item> HENSHIN_ONSA_KYOKI = ITEMS.register("henshin_onsa_kyoki",
        () -> new RiderFormChangeItem(new Item.Properties(),0,"","kyoki","kyosukedriver_belt",
                new MobEffectInstance(MobEffects.DAMAGE_BOOST, 40, 0,true,false),
                new MobEffectInstance(MobEffects.DIG_SPEED, 40, 1,true,false),
                new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 40, 0,true,false)).AddToTabList(RiderTabs.HIBIKI_TAB_ITEM));

        public static final RegistryObject<Item> HENSHIN_ONSA_KABUKI = ITEMS.register("henshin_onsa_kabuki",
        ...
        public static final RegistryObject<Item> HENSHIN_ONSA_TOUKI = ITEMS.register("henshin_onsa_touki",
        ...
        public static final RegistryObject<Item> HENSHIN_ONIBUE_IBUKI = ITEMS.register("henshin_onibue_ibuki",
        () -> new RiderFormChangeItem(new Item.Properties(),0,"","ibuki","ibukidriver_belt",
                new MobEffectInstance(MobEffects.DAMAGE_BOOST, 40, 1,true,false),
                new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 40, 1,true,false),
                new MobEffectInstance(MobEffects.DIG_SPEED, 40, 0,true,false)).AddToTabList(RiderTabs.HIBIKI_TAB_ITEM));

        public static final RegistryObject<Item> HENSHIN_ONIBUE_TOKI = ITEMS.register("henshin_onibue_toki",
        ...
        public static final RegistryObject<Item> HENSHIN_KIGEN_ZANKI = ITEMS.register("henshin_kigen_zanki",
        ...
        public static final RegistryObject<Item> HIBIKIHELMET = ITEMS.register("hibikihead",
        ...
        public static final RegistryObject<Item> HIBIKICHESTPLATE = ITEMS.register("hibikitroso",
        ...
        public static final RegistryObject<Item> HIBIKILEGGINGS = ITEMS.register("hibikilegs",
        ...
        public static final RegistryObject<Item> HIBIKIDRIVER = ITEMS.register("hibikidriver",
        ...
        public static final RegistryObject<Item> IBUKIDRIVER = ITEMS.register("ibukidriver",
        ...
        public static final RegistryObject<Item> TODOROKIDRIVER = ITEMS.register("todorokidriver",
        ...
        public static final RegistryObject<Item> ZANKIDRIVER = ITEMS.register("zankidriver",
        ...
        public static final RegistryObject<Item> EIKIDRIVER = ITEMS.register("eikidriver",
        ...
        public static final RegistryObject<Item> DANKIDRIVER = ITEMS.register("dankidriver",
        ...
        public static final RegistryObject<Item> SABAKIDRIVER = ITEMS.register("sabakidriver",
        ...
        public static final RegistryObject<Item> SHUKIDRIVER = ITEMS.register("shukidriver",
        ...
        public static final RegistryObject<Item> GOUKIDRIVER = ITEMS.register("goukidriver",
        ...
        public static final RegistryObject<Item> TOKIDRIVER = ITEMS.register("tokidriver",
        ...
        public static final RegistryObject<Item> SHOUKIDRIVER = ITEMS.register("shoukidriver",
        ...
        public static final RegistryObject<Item> BANKIDRIVER = ITEMS.register("bankidriver",
        ...
        public static final RegistryObject<Item> AMAKIDRIVER = ITEMS.register("amakidriver",
        ...
        public static final RegistryObject<Item> KYOSUKEDRIVER = ITEMS.register("kyosukedriver",
        ...
        public static final RegistryObject<Item> KABUKIDRIVER = ITEMS.register("kabukidriver",
        ...
        public static final RegistryObject<Item> TOUKIDRIVER = ITEMS.register("toukidriver",
        ...
        public static final RegistryObject<Item> KIRAMEKIDRIVER = ITEMS.register("kiramekidriver",
        ...
        public static final RegistryObject<Item> NISHIKIDRIVER = ITEMS.register("nishikidriver",
        ...
        public static final RegistryObject<Item> HABATAKIDRIVER = ITEMS.register("habatakidriver",
        ...
        public static final RegistryObject<Item> FUBUKIDRIVER = ITEMS.register("fubukidriver",
        ...
        public static final RegistryObject<SwordItem> ONGEKIBO_REKKA = ITEMS.register("ongekibo_rekka",
        ...
        public static final RegistryObject<SwordItem> ARMED_SABER = ITEMS.register("armed_saber",
        ...
        public static final RegistryObject<SwordItem> ONGEKIBO_YAMASE = ITEMS.register("ongekibo_yamase",
                () -> new BaseSwordItem(Tiers.DIAMOND, 4, -2.4F, new Item.Properties()).AddToTabList(RiderTabs.HIBIKI_TAB_ITEM).ChangeRepairItem(ONI_ORE.get()));
        public static final RegistryObject<SwordItem> ONGEKIBO_RAKURAI = ITEMS.register("ongekibo_rakurai",
                () -> new BaseSwordItem(Tiers.DIAMOND, 4, -2.4F, new Item.Properties()).AddToTabList(RiderTabs.HIBIKI_TAB_ITEM).ChangeRepairItem(ONI_ORE.get()));
        public static final RegistryObject<SwordItem> ONGEKIBO_SHAKUBYOUSHI = ITEMS.register("ongekibo_shakubyoushi",
                () -> new BaseSwordItem(Tiers.DIAMOND, 4, -2.4F, new Item.Properties()).AddToTabList(RiderTabs.HIBIKI_TAB_ITEM).ChangeRepairItem(ONI_ORE.get()));
        public static final RegistryObject<SwordItem> ONGEKIBO_NACHIGURO = ITEMS.register("ongekibo_nachiguro",
                () -> new BaseSwordItem(Tiers.DIAMOND, 4, -2.4F, new Item.Properties()).AddToTabList(RiderTabs.HIBIKI_TAB_ITEM).ChangeRepairItem(ONI_ORE.get()));
        public static final RegistryObject<SwordItem> ONGEKIBO_ROKUSHOU = ITEMS.register("ongekibo_rokushou",
                () -> new BaseSwordItem(Tiers.DIAMOND, 4, -2.4F, new Item.Properties()).AddToTabList(RiderTabs.HIBIKI_TAB_ITEM).ChangeRepairItem(ONI_ORE.get()));
        public static final RegistryObject<SwordItem> ONGEKIBO_GOURIKI = ITEMS.register("ongekibo_gouriki",
                () -> new BaseSwordItem(Tiers.DIAMOND, 4, -2.4F, new Item.Properties()).AddToTabList(RiderTabs.HIBIKI_TAB_ITEM).ChangeRepairItem(ONI_ORE.get()));
        public static final RegistryObject<SwordItem> ONGEKIBO_RESSUI = ITEMS.register("ongekibo_ressui",
                () -> new BaseSwordItem(Tiers.DIAMOND, 4, -2.4F, new Item.Properties()).AddToTabList(RiderTabs.HIBIKI_TAB_ITEM).ChangeRepairItem(ONI_ORE.get()));
          
        public static final RegistryObject<BaseBlasterItem> ONGEKIKAN_REPPUU = ITEMS.register("ongekikan_reppuu",
        ...
        public static final RegistryObject<SwordItem> ONGEKIGEN_RETSURAI = ITEMS.register("ongekigen_retsurai",
        ...
        public static final RegistryObject<SwordItem> ONGEKI_SHINGEN_RETSUZAN = ITEMS.register("ongeki_shingen_retsuzan",
                () -> new BaseSwordItem(Tiers.DIAMOND, 6, -2.4F, new Item.Properties()).AddToTabList(RiderTabs.HIBIKI_TAB_ITEM).ChangeRepairItem(ONI_ORE.get()));
        public static final RegistryObject<SwordItem> ONGEKIGEN_ENMA = ITEMS.register("ongekigen_enma",
                () -> new BaseSwordItem(Tiers.DIAMOND, 6, -2.4F, new Item.Properties()).AddToTabList(RiderTabs.HIBIKI_TAB_ITEM).ChangeRepairItem(ONI_ORE.get()));
        public static final RegistryObject<SwordItem> ONGEKIGEN_TOGENKYO = ITEMS.register("ongekigen_togenkyo",
                () -> new BaseSwordItem(Tiers.DIAMOND, 6, -2.4F, new Item.Properties()).AddToTabList(RiderTabs.HIBIKI_TAB_ITEM).ChangeRepairItem(ONI_ORE.get()));
        
        public static final RegistryObject<SwordItem> ECHO_SWORD_ONSAKEN = ITEMS.register("echo_sword_onsaken",
        ...
        public static final RegistryObject<SwordItem> ONGEKIKANABO_RETTO = ITEMS.register("ongekikanabo_retto",
                () -> new BaseSwordItem(Tiers.DIAMOND, 6, -2.4F, new Item.Properties()).AddToTabList(RiderTabs.HIBIKI_TAB_ITEM).ChangeRepairItem(ONI_ORE.get()));
        public static final RegistryObject<SwordItem> ONGEKISANKAKU_RESSETSU = ITEMS.register("ongekisankaku_ressetsu",
                () -> new BaseSwordItem(Tiers.DIAMOND, 4, -2.4F, new Item.Properties()).AddToTabList(RiderTabs.HIBIKI_TAB_ITEM).ChangeRepairItem(ONI_ORE.get()));
        public static final RegistryObject<SwordItem> ONGEKI_SHINCHO_RETSUBAN = ITEMS.register("ongeki_shincho_retsuban",
                () -> new BaseSwordItem(Tiers.DIAMOND, 4, -2.4F, new Item.Properties()).AddToTabList(RiderTabs.HIBIKI_TAB_ITEM).ChangeRepairItem(ONI_ORE.get()));
