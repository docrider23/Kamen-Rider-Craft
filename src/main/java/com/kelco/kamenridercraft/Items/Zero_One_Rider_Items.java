...
public class Zero_One_Rider_Items {
	...
	public static final RegistryObject<Item> CRUSHING_BUFFALO_PROGRISEKEY = ITEMS.register("crushing_buffalo_progrisekey",
            () -> new RiderFormChangeItem(new Item.Properties(),0,"","buffalo_raider","raidriser_belt_b",
            		new MobEffectInstance(Effect_core.BOOST.get(), 40, 1,true,false),
            		new MobEffectInstance(MobEffects.DAMAGE_BOOST, 40, 1,true,false))
	...
	public static final RegistryObject<Item> STORMING_PENGUIN_PROGRISEKEY = ITEMS.register("storming_penguin_progrisekey",
            () -> new RiderFormChangeItem(new Item.Properties(),0,"","penguin_raider","raidriser_belt_pe",
            		new MobEffectInstance(MobEffects.WATER_BREATHING, 40, 0,true,false),
            		new MobEffectInstance(MobEffects.DIG_SPEED, 40, 1,true,false),
            		new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 40, 1,true,false))
	...
	public static final RegistryObject<Item> SPLASHING_WHALE_PROGRISEKEY = ITEMS.register("splashing_whale_progrisekey",
            () -> new RiderFormChangeItem(new Item.Properties(),0,"","whale_raider","raidriser_belt_w",
            		new MobEffectInstance(MobEffects.DOLPHINS_GRACE, 40, 1,true,false),
            		new MobEffectInstance(MobEffects.WATER_BREATHING, 40, 0,true,false),
            		new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 40, 1,true,false),
            		new MobEffectInstance(MobEffects.DAMAGE_BOOST, 40, 1,true,false))
	...
	public static final RegistryObject<Item> DYNAMAITING_LION_PROGRISEKEY = ITEMS.register("dynamaiting_lion_progrisekey",
            () -> new RiderFormChangeItem(new Item.Properties(),0,"","lion_raider","raidriser_belt_l",
            		new MobEffectInstance(MobEffects.JUMP, 40, 1,true,false),
            		new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 40, 2,true,false),
            		new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 40, 2,true,false))
	...
	public static final RegistryObject<Item> SCOUTING_PANDA_PROGRISEKEY = ITEMS.register("scouting_panda_progrisekey",
            () -> new RiderFormChangeItem(new Item.Properties(),0,"","panda_raider","raidriser_belt_p",
            		new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 40, 2,true,false),
            		new MobEffectInstance(MobEffects.NIGHT_VISION, 400, 0,true,false))
	...
	public static final RegistryObject<Item> INVADING_HORSESHOE_CRAB_PROGRISEKEY = ITEMS.register("invading_horseshoe_crab_progrisekey",
            () -> new RiderFormChangeItem(new Item.Properties(),0,"","battle_raider","raidriser_belt",
            		new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 40, 3,true,false),
            		new MobEffectInstance(MobEffects.DAMAGE_BOOST, 40, 2,true,false))
...
//			.AddToTabList(RiderTabs.ZERO_ONE_TAB_ITEM));
	...
	public static final RegistryObject<Item> ARSINO_ZETSUMERISEKEY = ITEMS.register("arsino_zetsumerisekey",
            () -> new RiderFormChangeItem(new Item.Properties(),0,"","arsino_magia","zetsumeriser_belt_a")
			.AddToTabList(RiderTabs.ZERO_ONE_TAB_ITEM));
...
//    		() -> new RiderDriverItem(ArmorMaterials.DIAMOND,"ragnarok",RAGNAROK_PROGRISEKEY ,ZERO_ONE_HELMET, ZERO_ONE_CHESTPLATE,ZERO_ONE_LEGGINGS , new Item.Properties()).AddToTabList(RiderTabs.ZERO_ONE_TAB_ITEM).ChangeRepairItem(HIDEN_METAL.get()));
	...
	public static final RegistryObject<Item> ZETSUMERISER_DODO_CUSTOM_2 = ITEMS.register("zetsumeriser_dodo_custom_2",
    		() -> new RiderDriverItem(ArmorMaterials.DIAMOND,"dodo_magia_custom_2",DODO_CUSTOM_2_ZETSUMERISEKEY ,ZERO_ONE_HELMET, ZERO_ONE_CHESTPLATE,ZERO_ONE_LEGGINGS , new Item.Properties()).AddToTabList(RiderTabs.ZERO_ONE_TAB_ITEM).ChangeRepairItem(HIDEN_METAL.get()));
	...
	public static final RegistryObject<Item> RAIDRISER_BATTLE = ITEMS.register("raidriser_battle",
    		() -> new RiderDriverItem(ArmorMaterials.DIAMOND,"battle_raider",INVADING_HORSESHOE_CRAB_PROGRISEKEY ,ZERO_ONE_HELMET, ZERO_ONE_CHESTPLATE,ZERO_ONE_LEGGINGS , new Item.Properties()).AddToTabList(RiderTabs.ZERO_ONE_TAB_ITEM).ChangeRepairItem(HIDEN_METAL.get()));
	public static final RegistryObject<Item> RAIDRISER_BUFFALO = ITEMS.register("raidriser_buffalo",
    		() -> new RiderDriverItem(ArmorMaterials.DIAMOND,"buffalo_raider",CRUSHING_BUFFALO_PROGRISEKEY ,ZERO_ONE_HELMET, ZERO_ONE_CHESTPLATE,ZERO_ONE_LEGGINGS , new Item.Properties()).AddToTabList(RiderTabs.ZERO_ONE_TAB_ITEM).ChangeRepairItem(HIDEN_METAL.get()));
	public static final RegistryObject<Item> RAIDRISER_WHALE = ITEMS.register("raidriser_whale",
    		() -> new RiderDriverItem(ArmorMaterials.DIAMOND,"whale_raider",SPLASHING_WHALE_PROGRISEKEY ,ZERO_ONE_HELMET, ZERO_ONE_CHESTPLATE,ZERO_ONE_LEGGINGS , new Item.Properties()).AddToTabList(RiderTabs.ZERO_ONE_TAB_ITEM).ChangeRepairItem(HIDEN_METAL.get()));
	public static final RegistryObject<Item> RAIDRISER_LION = ITEMS.register("raidriser_lion",
    		() -> new RiderDriverItem(ArmorMaterials.DIAMOND,"lion_raider",DYNAMAITING_LION_PROGRISEKEY ,ZERO_ONE_HELMET, ZERO_ONE_CHESTPLATE,ZERO_ONE_LEGGINGS , new Item.Properties()).AddToTabList(RiderTabs.ZERO_ONE_TAB_ITEM).ChangeRepairItem(HIDEN_METAL.get()));
	public static final RegistryObject<Item> RAIDRISER_PENGUIN = ITEMS.register("raidriser_penguin",
    		() -> new RiderDriverItem(ArmorMaterials.DIAMOND,"penguin_raider",STORMING_PENGUIN_PROGRISEKEY ,ZERO_ONE_HELMET, ZERO_ONE_CHESTPLATE,ZERO_ONE_LEGGINGS , new Item.Properties()).AddToTabList(RiderTabs.ZERO_ONE_TAB_ITEM).ChangeRepairItem(HIDEN_METAL.get()));
	public static final RegistryObject<Item> RAIDRISER_PANDA = ITEMS.register("raidriser_panda",
    		() -> new RiderDriverItem(ArmorMaterials.DIAMOND,"panda_raider",SCOUTING_PANDA_PROGRISEKEY ,ZERO_ONE_HELMET, ZERO_ONE_CHESTPLATE,ZERO_ONE_LEGGINGS , new Item.Properties()).AddToTabList(RiderTabs.ZERO_ONE_TAB_ITEM).ChangeRepairItem(HIDEN_METAL.get()));
	public static final RegistryObject<Item> RAIDRISER_JACKAL = ITEMS.register("raidriser_jackal",
    		() -> new RiderDriverItem(ArmorMaterials.DIAMOND,"jackal_raider",FIGHTING_JACKAL_PROGRISEKEY ,ZERO_ONE_HELMET, ZERO_ONE_CHESTPLATE,ZERO_ONE_LEGGINGS , new Item.Properties()).AddToTabList(RiderTabs.ZERO_ONE_TAB_ITEM).ChangeRepairItem(HIDEN_METAL.get()));
