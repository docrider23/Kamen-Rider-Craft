...
public class OOO_Rider_Items {
	...
	public static final RegistryObject<Item> KUJAKU_MEDAL = ITEMS.register("kujaku_medal",
			...
			.ChangeSlot(2).ifFlyingModelResource( "geo/ooo_rider_plusbelt_and_wings.geo.json").AddToTabList(RiderTabs.OOO_TAB_ITEM));
	...
	public static final RegistryObject<Item> ZEUS_PTERA_MEDAL = ITEMS.register("zeus_ptera_medal",
			() -> new CopyFormChangeItem(new Item.Properties(),PTERA_MEDAL.get()).AddToTabList(RiderTabs.OOO_TAB_ITEM));

	public static final RegistryObject<Item> ZEUS_TRICERA_MEDAL = ITEMS.register("zeus_tricera_medal",
			() -> new CopyFormChangeItem(new Item.Properties(),TRICERA_MEDAL.get()).AddToTabList(RiderTabs.OOO_TAB_ITEM));

	public static final RegistryObject<Item> ZEUS_TYRANNO_MEDAL = ITEMS.register("zeus_tyranno_medal",
			() -> new CopyFormChangeItem(new Item.Properties(),TYRANNO_MEDAL.get()).AddToTabList(RiderTabs.OOO_TAB_ITEM));


	public static final RegistryObject<Item> ZEUS_MUKADE_MEDAL = ITEMS.register("zeus_mukade_medal",
			() -> new CopyFormChangeItem(new Item.Properties(),MUKADE_MEDAL.get()).AddToTabList(RiderTabs.OOO_TAB_ITEM));

	public static final RegistryObject<Item> ZEUS_HACHI_MEDAL = ITEMS.register("zeus_hachi_medal",
			() -> new CopyFormChangeItem(new Item.Properties(),HACHI_MEDAL.get()).AddToTabList(RiderTabs.OOO_TAB_ITEM));

	public static final RegistryObject<Item> ZEUS_ARI_MEDAL = ITEMS.register("zeus_ari_medal",
			() -> new CopyFormChangeItem(new Item.Properties(),ARI_MEDAL.get()).AddToTabList(RiderTabs.OOO_TAB_ITEM));;
			...
			public static final RegistryObject<Item> BIRTH_CORE_EYES = ITEMS.register("birth_core_eyes",
					...
					.IsGlowing().AddCompatibilityList(new String[] {"birth_prototype"}).AddToTabList(CellMedalProgramer.CELL_MEDAL).AddToTabList(RiderTabs.OOO_TAB_ITEM));
			...
			public static final RegistryObject<BaseBlasterItem> TAJASPINNER = ITEMS.register("tajaspinner",
					() -> new BaseBlasterItem(Tiers.DIAMOND, 5, -2.4F, new Item.Properties()).IsSwordGun().setProjectileFireball().AddToTabList(RiderTabs.OOO_TAB_ITEM).ChangeRepairItem(CELL_MEDAL.get()));

			public static final RegistryObject<BaseBlasterItem> MEDAGABURYU = ITEMS.register("medagaburyu",
					() -> new BaseBlasterItem(Tiers.DIAMOND, 12, -2.4F, new Item.Properties()).IsSwordGun().setProjectileWitherSkull().AddToTabList(RiderTabs.OOO_TAB_ITEM).ChangeRepairItem(CELL_MEDAL.get()));

			public static final RegistryObject<BaseBlasterItem> TAJASPINNER_ETERNITY = ITEMS.register("tajaspinner_eternity",
					() -> new BaseBlasterItem(Tiers.DIAMOND, 9, -2.4F, new Item.Properties()).IsSwordGun().setProjectileLargeFireball(1).AddToTabList(RiderTabs.OOO_TAB_ITEM).ChangeRepairItem(CELL_MEDAL.get()));
			...
			public static final RegistryObject<SwordItem> ANICENT_OOO_GREEED_SWORD = ITEMS.register("ancient_ooo_greeed_sword",
					() -> new BaseSwordItem(Tiers.DIAMOND, 11, -2.4F, new Item.Properties()).AddToTabList(RiderTabs.OOO_TAB_ITEM).ChangeRepairItem(CELL_MEDAL.get()));
