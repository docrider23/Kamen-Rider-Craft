...
public class Decade_Rider_Items {
    ...
    public static final RegistryObject<Item> KUUGA_MIGHTY = ITEMS.register("kuuga_mighty_card",
            () -> new RiderFormChangeItem(new Item.Properties(),0,"","decade","decadriver_belt",
    ...
    public static final RegistryObject<Item> KUUGA_DRAGON = ITEMS.register("kuuga_dragon_card",
            () -> new RiderFormChangeItem(new Item.Properties(),0,"_dragon","decade","decadriver_belt",
            		new MobEffectInstance(MobEffects.DIG_SPEED, 40, 0,true,false),
            		new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 40, 0,true,false))
            .ChangeRiderName("kuuga").IsGlowing().AddToTabList(RiderTabs.DECADE_TAB_ITEM));

    public static final RegistryObject<Item> KUUGA_PEGASUS = ITEMS.register("kuuga_pegasus_card",
            () -> new RiderFormChangeItem(new Item.Properties(),0,"_pegasus","decade","decadriver_belt",
            		new MobEffectInstance(MobEffects.NIGHT_VISION, 400, 0,true,false),
            		new MobEffectInstance(MobEffects.JUMP, 40, 2,true,false))
            .ChangeRiderName("kuuga").IsGlowing().AddToTabList(RiderTabs.DECADE_TAB_ITEM));

    public static final RegistryObject<Item> KUUGA_TITAN = ITEMS.register("kuuga_titan_card",
    ...
    public static final RegistryObject<Item> KUUGA_RISING_MIGHTY = ITEMS.register("kuuga_rising_mighty_card",
    ...
    public static final RegistryObject<Item> KUUGA_RISING_DRAGON = ITEMS.register("kuuga_rising_dragon_card",
    ...
    public static final RegistryObject<Item> KUUGA_RISING_PEGASUS = ITEMS.register("kuuga_rising_pegasus_card",
    ...
    public static final RegistryObject<Item> KUUGA_RISING_TITAN = ITEMS.register("kuuga_rising_titan_card",
    ...
    public static final RegistryObject<Item> KUUGA_AMAZING_MIGHTY = ITEMS.register("kuuga_amazing_mighty_card",
    ...
    public static final RegistryObject<Item> AGITO_GROUND = ITEMS.register("agito_ground_card",
            () -> new RiderFormChangeItem(new Item.Properties(),0,"","decade","decadriver_belt",
            		new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 40, 0,true,false),
            		new MobEffectInstance(MobEffects.DAMAGE_BOOST, 40, 0,true,false))
            .ChangeRiderName("agito").IsGlowing().AddToTabList(RiderTabs.DECADE_TAB_ITEM));

    public static final RegistryObject<Item> AGITO_STORM = ITEMS.register("agito_storm_card",
            () -> new RiderFormChangeItem(new Item.Properties(),0,"_storm","decade","decadriver_belt",
            		new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 40, 1,true,false),
            		new MobEffectInstance(MobEffects.JUMP, 40, 0,true,false))
            .ChangeRiderName("agito").IsGlowing().AddToTabList(RiderTabs.DECADE_TAB_ITEM));

    public static final RegistryObject<Item> AGITO_FLAME = ITEMS.register("agito_flame_card",
